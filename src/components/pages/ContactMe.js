    ...
    <main className="container row home-main mx-auto mt-lg-5 ">
        ...
        <div className="container py-4">
          ...
          >
            ...
            <div className="d-grid">
              <button
                id="button-teal"
                className="btn btn-lg inputGroup mt-2"
                type="submit"
                name="action"
              >
                Submit
      ...
      <div className="col-lg-6 col-md-12 p-5">
        <h4 className="mb-3 elem-2">
          Github:{" "}
          <a href="https://github.com/Muiasar-Al-Ani">
            <span className="px-2">https://github.com/Muiasar-Al-Ani</span>
          </a>
        </h4>
        <h4 className="mb-3 elem-2">
          Email:{" "}
        ...
        <h4 className="mb-3 elem-2">
          Phone:{" "}
          <a href="tel:919-931-8429">
            <span className="px-2">919-931-8429</span>
          </a>
        </h4>
        <h4 className="mb-3 elem-2">
          LinkedIn:{" "}
          <a href="https://www.linkedin.com/in/muiasar-al-ani-71476420b/">
            <span className="px-2">
              https://www.linkedin.com/in/muiasar-al-ani-71476420b/
            </span>
          </a>
        </h4>
        <a
